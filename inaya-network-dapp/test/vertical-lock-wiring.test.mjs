...
const ALL_ROUTES = [...HEALTH_ROUTES.map((f) => ({ file: f, vertical: "healthcare" })), ...LEGAL_ROUTES.map((f) => ({ file: f, vertical: "legal" }))];
...
test("sanity: found every expected health/legal route file (this test isn't silently checking zero files)", () => {
