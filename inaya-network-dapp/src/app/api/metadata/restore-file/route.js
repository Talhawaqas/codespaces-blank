// app/api/metadata/restore-file/route.js
//
// POST /api/metadata/restore-file
// Body: { fileHash, address, message, signature, timestamp }
//
// Undoes a prior delete-file call -- clears deletedAt, matching
// custody-sdk's metadata.js restoreFile() comment exactly.
...
export async function POST(req) {
  try {
    ...
    verifyMetadataAuth({ action: "restoreFile", resourceId: fileHash, address, message, signature, timestamp });
    ...
    console.error("metadata/restore-file failed:", err);
