...
export const POST = workflowRoute(async ({ orgId, membership, email, params, body, query }) => svc.importWorkflow({ orgId, membership, actorEmail: email, payload: body.payload, name: body.name }), { okStatus: 201 });
