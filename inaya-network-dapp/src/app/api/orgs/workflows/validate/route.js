...
import { validateDraft } from "../../../../../lib/workflows/catalog.js";

export const POST = workflowRoute(async ({ orgId, membership, email, params, body, query }) => validateDraft({ orgId, membership, email, body }));
