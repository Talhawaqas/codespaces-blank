...
export const POST = workflowRoute(async ({ orgId, membership, email, params, body, query }) => svc.setWorkflowAcl({ orgId, id: params.id, membership, actorEmail: email, acl: body.acl }));
