...
export const POST = workflowRoute(async ({ orgId, membership, email, params, body, query }) => svc.executeWorkflow({ orgId, id: params.id, membership, actorEmail: email, mode: body.dryRun ? 'dry_run' : 'production', payload: body.payload, wait: body.wait !== false }));
