...
export const POST = workflowRoute(async ({ orgId, membership, email, params, body, query }) => svc.rollbackWorkflow({ orgId, id: params.id, version: body.version, membership, actorEmail: email }));
