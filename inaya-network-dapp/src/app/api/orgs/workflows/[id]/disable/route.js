...
export const POST = workflowRoute(async ({ orgId, membership, email, params, body, query }) => svc.setWorkflowEnabled({ orgId, id: params.id, membership, actorEmail: email, enabled: false }));
