...
export const GET = workflowRoute(async ({ orgId, membership, email, params, body, query }) => svc.exportWorkflow({ orgId, id: params.id, membership, email, version: query.version || null }));
