...
export const GET = workflowRoute(async ({ orgId, membership, email, params, body, query }) => svc.getVersion({ orgId, id: params.id, version: params.version, membership, email }));
