...
export const POST = workflowRoute(async ({ orgId, membership, email, params, body, query }) => svc.publishWorkflow({ orgId, id: params.id, membership, actorEmail: email, note: body.note }));
