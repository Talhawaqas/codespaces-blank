...
export const POST = workflowRoute(async ({ orgId, membership, email, params, body, query }) => svc.cancelExecution({ orgId, executionId: params.executionId, membership, actorEmail: email }));
