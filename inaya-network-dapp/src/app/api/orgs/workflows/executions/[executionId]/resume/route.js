...
export const POST = workflowRoute(async ({ orgId, membership, email, params, body, query }) => svc.resumeExecution({ orgId, executionId: params.executionId, membership, actorEmail: email }));
