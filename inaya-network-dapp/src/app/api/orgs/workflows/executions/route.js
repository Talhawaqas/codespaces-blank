...
export const GET = workflowRoute(async ({ orgId, membership, email, params, body, query }) => svc.listExecutions({ orgId, membership, email, workflowId: query.workflowId || null, status: query.status || null, mode: query.mode || 'production', limit: query.limit, before: query.before || null }));
