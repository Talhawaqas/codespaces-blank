...
export const GET = workflowRoute(async ({ orgId, membership, email, params, body, query }) => metrics.getWorkflowMetrics({ orgId, membership, email, days: Number(query.days) || 30 }));
